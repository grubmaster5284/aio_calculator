...
/// Standalone Exchangerate-api.com service for fallback
/// This service has hardcoded configuration and doesn't depend on CurrencyServiceFactory
class StandaloneExchangerateService implements ICurrencyApiService {
  final http.Client _client;
  final String _baseUrl = 'https://api.exchangerate-api.com/v4';
  final int _timeout = 10000;
  final int _retryAttempts = 3;
  final int _retryDelay = 2000;

  StandaloneExchangerateService({http.Client? client})
